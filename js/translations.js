...
const translations = {
    en: {
        ...
        home: {
            ...
            ready_subtitle: "Join thousands of organizations already using Emma",
        ...
        industries: {
            ...
            cta: {
                ...
                description: "Join thousands of organizations already using Emma's AI agents to revolutionize their operations and deliver exceptional results.",
                stats: {
                    companies: "Companies",
        ...
        footer: {
            brand: {
                name: "Hi Emma",
                tagline: "Intelligent AI Assistant Platform",
        ...
        footer: {
            ...
            bottom: {
                copyright: "© 2024 KodeFast. All rights reserved. Building the future of autonomous AI agents.",
                privacy_policy: "Privacy Policy",
                terms_of_service: "Terms of Service",
                cookie_policy: "Cookie Policy",
                accessibility: "Accessibility"
        ...
        // Contact Page
        contact: {
            title: "Contact Hi Emma",
            subtitle: "Get Started with AI Automation",
            description: "Contact Hi Emma to discuss your AI automation needs. Schedule a demo, get a custom quote, or speak with our AI experts about Healthcare, Banking, and Education solutions.",
            form: {
                name: "Full Name",
                email: "Email Address",
                company: "Company",
            ...
            demo: {
                ...
                description: "See Emma in action with a personalized demonstration tailored to your industry and use case.",
                options: [
                    {
                        title: "Healthcare Demo",
                        description: "See how Emma transforms patient care and administrative workflows"
                    },
                    {
                        title: "Banking Demo",
                        description: "Experience Emma's financial services automation capabilities"
                    },
                    {
                        title: "Education Demo",
                        description: "Discover Emma's educational support and learning management features"
                    }
                ],
                form: {
                    name: "Full Name",
                    ...
                    success: "Thank you for scheduling a demo! We'll contact you within 24 hours to confirm the details."
                }
            },
            info: {
                email: "Email",
        ...
        about: {
            title: "About Hi Emma",
            subtitle: "Building the Future of Autonomous AI Agents",
            ...
            mission: {
                title: "Our Mission",
                description: "To democratize AI technology and make intelligent automation accessible to organizations of all sizes, transforming how businesses operate and serve their customers."
            },
            vision: {
                title: "Our Vision",
            ...
            team: {
                title: "Meet Our Team",
                description: "The brilliant minds behind Hi Emma's innovative AI solutions"
            },
            stats: {
    ...
    ar: {
        ...
        home: {
            ...
            ready_subtitle: "انضم إلى آلاف المنظمات التي تستخدم إيما بالفعل",
        ...
        footer: {
            ...
            copyright: "كودفاست. جميع الحقوق محفوظة. بناء مستقبل وكلاء الذكاء الاصطناعي المستقلين.",
            legal: {
        ...
        footer: {
            ...
            newsletter: {
                title: "ابق محدثاً",
                description: "احصل على أحدث رؤى الذكاء الاصطناعي وتحديثات المنتج مباشرة في صندوق الوارد الخاص بك.",
                placeholder: "أدخل بريدك الإلكتروني",
                subscribe: "اشترك",
                disclaimer: "نحن نحترم خصوصيتك. يمكنك إلغاء الاشتراك في أي وقت."
            },
            bottom: {
                copyright: "© 2024 كود فاست. جميع الحقوق محفوظة. بناء مستقبل وكلاء الذكاء الاصطناعي المستقلين.",
                privacy_policy: "سياسة الخصوصية",
                terms_of_service: "شروط الخدمة",
                cookie_policy: "سياسة ملفات تعريف الارتباط",
                accessibility: "إمكانية الوصول"
        ...
        contact: {
            title: "اتصل بإيما",
            subtitle: "ابدأ مع أتمتة الذكاء الاصطناعي",
            description: "اتصل بإيما لمناقشة احتياجاتك في أتمتة الذكاء الاصطناعي. حدد موعد عرض توضيحي، احصل على عرض أسعار مخصص، أو تحدث مع خبراء الذكاء الاصطناعي حول حلول الرعاية الصحية والبنوك والتعليم.",
            form: {
                name: "الاسم الكامل",
            ...
            demo: {
                ...
                description: "شاهد إيما في العمل مع عرض توضيحي شخصي مصمم لصناعتك وحالة الاستخدام.",
                options: [
                    {
                        title: "عرض توضيحي للرعاية الصحية",
                        description: "شاهد كيف تحول إيما رعاية المرضى وسير العمل الإداري"
                    },
                    {
                        title: "عرض توضيحي للبنوك",
                        description: "اختبر قدرات أتمتة الخدمات المالية لإيما"
                    },
                    {
                        title: "عرض توضيحي للتعليم",
                        description: "اكتشف ميزات الدعم التعليمي وإدارة التعلم لإيما"
                    }
                ],
                form: {
                    name: "الاسم الكامل",
                    ...
                    company: "الشركة",
                    phone: "رقم الهاتف",
                    preferred_time: "وقت العرض التوضيحي المفضل",
                    use_case: "حالة الاستخدام الأساسية",
                    submit: "حدد موعد العرض التوضيحي",
                    success: "شكراً لتحديد موعد العرض التوضيحي! سنتواصل معك خلال 24 ساعة لتأكيد التفاصيل."
                }
            },
            info: {
        ...
        about: {
            ...
            mission: {
                title: "مهمتنا",
                description: "ديمقراطية تقنية الذكاء الاصطناعي وجعل الأتمتة الذكية متاحة للمنظمات من جميع الأحجام، وتحويل كيفية عمل الشركات وخدمة عملائها."
            },
            vision: {
                title: "رؤيتنا",
            ...
            team: {
                ...
                description: "العقول اللامعة وراء حلول الذكاء الاصطناعي المبتكرة لإيما"
            },
            stats: {
                title: "بالأرقام",
                items: [
