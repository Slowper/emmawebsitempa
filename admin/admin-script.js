...
class EnhancedCMS {
    ...
    async loadUseCasesContent() {
        try {
            const response = await fetch(`${this.apiBase}/content/usecases`);
            if (response.ok) {
    ...
    async editUseCase(useCaseId) {
        try {
            const response = await fetch(`${this.apiBase}/content/usecases/${useCaseId}`);
            if (response.ok) {
    ...
    async loadCaseStudiesContent() {
        try {
            const response = await fetch(`${this.apiBase}/content/casestudies`);
            if (response.ok) {
    ...
    async editCaseStudy(caseStudyId) {
        try {
            const response = await fetch(`${this.apiBase}/content/casestudies/${caseStudyId}`);
            if (response.ok) {
